...
/////// Diffuse:
                ...
                float3 diffuseColor = ((node_9877.a*_Opacity_var*node_9877.rgb*(((1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),_OuterFresnel_var))*(1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),_InnerFresnel_var)))*2.0))*i.vertexColor.rgb*_Color_var.rgb*4.0*i.vertexColor.a);
